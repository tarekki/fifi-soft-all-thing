 ...
 * 
 * Modern, professional login page with:
 ...
 * - Smooth animations
 * 
 * صفحة تسجيل دخول حديثة واحترافية مع:
            ...
            <AnimatePresence>
              {(formError || error) && (
                ...
                >
                  ...
                  <p className="text-sm text-red-700 dark:text-red-300 font-medium">{formError || error}</p>
                </motion.div>
              )}
            </AnimatePresence>
