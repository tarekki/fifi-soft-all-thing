  ...
  return (
    ...
    >
      ...
      <button 
        ...
        className="w-full mt-6 text-center text-sm text-historical-gold dark:text-yellow-400 hover:text-historical-red dark:hover:text-yellow-300 transition-colors font-medium cursor-pointer"
      >
